...
class Validator {
  ...
  static String? validatePasswordStrengthMobile(String? password) {
  ...
  static String? validatePasswordStrengthDesktop(String? password) {
    if (passwordLogic(password)) {
      return null;
    }
  ...
  static bool passwordLogic(String? password) {
  ...
  static String? checkSameValue(String? value, String? value2) {
    if (value != value2) {
  ...
  static String? checkDuplicate(List<Role> roleList, String name) {
